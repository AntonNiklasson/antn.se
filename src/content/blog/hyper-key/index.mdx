...
I found myself creating conflicting shortcuts sometimes. To avoid confusion, I try to stick to to _global_ actions on the hyper key. When I bind something within an application, I tend to do it with <kbd>⌥</kbd><kbd>\{letter\}</kbd>.
