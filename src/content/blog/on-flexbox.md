...
According the [caniuse.com/flexbox][caniuse] around 80% of all people using the
web would be able to render flexbox. Nothing near perfect, but still enough for
some specific usecases I would say.

![caniuse.com/flexbox][caniuse-com-flexbox]

CSS-tricks have [an awesome guide][flexbox-guide] to all the flexbox properties.
It really covers most of it with some nice graphics.
...
[caniuse-com-flexbox]: ./assets/on-flexbox--caniuse-flexbox.png
