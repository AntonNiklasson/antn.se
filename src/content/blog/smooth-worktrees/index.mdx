...
new worktress from the current repositiory. I ~built~prompted it myself, to fit
my stack:
...
So here's the spec: I want a quick path to a clean read-to-go worktree,
...
would like to over, and then any commands I would like to run in the new
...
kicks of in the background, so I can come back to it later. Pretty
convenient. Check out the complete source code here: [`wt`](https://github.com/antonniklasson/dotfiles/blob/main/bin/wt)
...
tasks. So I'm dialing it back donw. But similar to any other technology
